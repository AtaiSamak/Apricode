    ...
    get disposeAsync() {
        ...
        if (weakBoundDisposeAsync.get(this) === undefined) {
            ...
            if (disposeAsync === undefined)
                throw new TypeError(`Method not found: ${AsyncDisposable.asyncDispose.toString()}`);
        ...
        // 5. Else, if value is neither null nor undefined, then
            ...
            if (method === undefined) {
                ...
                if (typeof value === "function") {
                    ...
                    AddDisposableResource(weakAsyncDisposableResourceStack.get(this), undefined, "async", value);
                }
                // ii. Else,
                else {
